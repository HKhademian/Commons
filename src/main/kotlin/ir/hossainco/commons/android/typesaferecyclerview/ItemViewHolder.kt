...
import ir.hossainco.commons.android.inflateItem
 ...
 */
abstract class ItemViewHolder<Data : Any, V : View, Host>(protected val host: Host, itemView: V)	: ViewHolder<V>(itemView) {
